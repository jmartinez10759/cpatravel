  ...
  <div class="row busqueda">
  	<div class="col-md-5 col-xs-12">
		<div class="col-md-4 col-xs-12 left">
			...
			<input type="text" class="form-search2 search_project" placeholder="Busque por Proyecto" style="font-size: 12px">
	  ...
	  <div class="col-md-4 col-xs-12 left">
		  ...
		  <span class="icon-subproyectos_verde"></span>
			Subproyecto:<br>
			<a href="#" style="text-decoration: underline; font-size: 12px; color: #009576;">Seleccionar</a><br>
			<input type="text" class="form-search2 search_subproject" placeholder="Busque por Subproyecto" style="font-size: 12px">
		...
		<div class="col-md-4 col-xs-12 left">
			...
			Viaje:<br>
			<a href="#" style="text-decoration: underline; font-size: 12px; color: #009576;">Seleccionar</a><br>
			<input type="text" class="form-search2 search_travel" placeholder="Busque por Viaje" style="font-size: 12px">
	  	...
	  	<div class="col-md-4 col-xs-6 left">
	  	  ...
	  	  <p>
	  	    <select name="status" id="status">
	  	      ...
	  	      <option value="2">Solicitando CFDI</option> 
	  	      <option value="3">CFDI en búsqueda</option> 
	  	      <option value="4">CFDI encontrado</option> 
	  	      <option value="5">Anticipo</option> 
	  	      <option value="6">Comprobables</option> 
	  	      <option value="7">No comprobables</option> 
	  	      <option value="8">Recepción de transferencia</option> 
	  	      <option value="9">Transferencia de saldo</option>
  	        </select>
  	      </p>
		  </div>
		  <div class="col-md-4 col-xs-6 left style="top:10px"">
	  	    <p>Etiqueta Predeterminada:            </p>
	  	    <p>
	  	      <select name="viaticos" id="viaticos"> 
	  	        <br>
	  	        <option value="1">Todos los tipos de viático</option>
	  	        <option value="2">Alimentos</option> 
	  	        <option value="3">Hospedaje</option> 
	  	        <option value="4">Transporte público</option> 
	  	        <option value="5">Renta de auto</option> 
	  	        <option value="6">Kilometraje</option> 
	  	        <option value="7">Gasolina</option> 
	  	        <option value="8">Seminarios y convenciones</option> 
	  	        <option value="9">Transporte aéreo</option>
	  	        <option value="10">Transporte terrestre</option>
  	          </select>
  	        </p>
		  </div>
