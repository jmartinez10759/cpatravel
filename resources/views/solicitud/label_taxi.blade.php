    ...
    <div class="row" style="margin-top: 10%">
        ...
        <div class="col-md-8">
            <table class="table">
                <tr>
                    <td rowspan="2">
                        <select name="type_nacional" id="select-type" class="form-control select-na hidden">
...
<script>
    $(document).ready(function(){
        ...
        $('#lugar_origen').val($lugar_origen);
        $('#lugar_destino').val($lugar_destino);*/
            ...
            if($submit == 0){
                if(parseFloat($valor) > parseFloat($('#monto_company_policies_id').val())){
                    ...
                    if($reques_id == ''){
                        ...
                        var datas = getFormData($form);
                        window.parent.taxi(datas,window.parent.$('#request_id').val());
                        window.parent.blurStuff(0);
                    }
                }
            }else{
