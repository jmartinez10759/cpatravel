	...
	<div class="container-fluid">
			...
			<form role="form" class="">
				<div class="col-sm-6">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" placeholder="Ingrese emisor">
				  </div>
				...
				<div class="col-sm-6">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="" placeholder="Ingrese Receptor">
				  </div>
					  ...
					  <div class="form-group">
					    	<label for="">IMPORTE</label>
						  	<div class="input-group">
							    ...
							    <input id="importe" type="text" class="form-control" placeholder="">
							</div>
					  </div>
		...
		<div class="row">
			...
			<div class="pull-right">
				<button type="button" class="btn btn-warning btn-lg">Buscar</button>
			</div>
